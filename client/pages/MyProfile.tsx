...
export default function AboutWithProfile() {
  return (
    <div className="w-full">

      {/* ------------------- 1. Hero Section: Mission and Vision ------------------- */}
      <section className="w-full py-12 lg:py-20 bg-gray-50 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          At Medizo, we believe access to essential medications and wellness products should be simple, affordable, and trustworthy. We are reinventing the pharmacy experience for the modern world.
        </p>
      </section>
